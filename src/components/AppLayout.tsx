  ...
  return (
    <div className={`min-h-screen font-sans ${useMobileLayout ? 'pb-16' : ''} ${className}`}>
      ...
      {isMenuOpen && (
        ...
        >
          <div 
            className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-border shadow-2xl rounded-t-3xl p-4 pb-20"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <a 
                href="/" 
                onClick={() => setIsMenuOpen(false)}
                className="flex flex-col items-center p-3 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl hover:from-primary/20 hover:to-primary/10 transition-all duration-200 active:scale-95"
              >
              ...
              <a 
                href="/packages" 
                onClick={() => setIsMenuOpen(false)}
                className="flex flex-col items-center p-3 bg-gradient-to-r from-secondary/10 to-secondary/5 rounded-xl hover:from-secondary/20 hover:to-secondary/10 transition-all duration-200 active:scale-95"
              >
              ...
              <a 
                href="/explore" 
                onClick={() => setIsMenuOpen(false)}
                className="flex flex-col items-center p-3 bg-gradient-to-r from-accent/10 to-accent/5 rounded-xl hover:from-accent/20 hover:to-accent/10 transition-all duration-200 active:scale-95"
              >
              ...
              <a 
                href="/my-tour" 
                onClick={() => setIsMenuOpen(false)}
                className="flex flex-col items-center p-3 bg-gradient-to-r from-muted-foreground/10 to-muted-foreground/5 rounded-xl hover:from-muted-foreground/20 hover:to-muted-foreground/10 transition-all duration-200 active:scale-95"
              >
              ...
              <a 
                href="/about" 
                onClick={() => setIsMenuOpen(false)}
                className="flex flex-col items-center p-3 bg-gradient-to-r from-emerald-500/10 to-emerald-400/5 rounded-xl hover:from-emerald-500/20 hover:to-emerald-400/10 transition-all duration-200 active:scale-95"
              >
              ...
              <a 
                href="/auth" 
                onClick={() => setIsMenuOpen(false)}
                className="flex flex-col items-center p-3 bg-gradient-to-r from-blue-500/10 to-blue-400/5 rounded-xl hover:from-blue-500/20 hover:to-blue-400/10 transition-all duration-200 active:scale-95"
              >
