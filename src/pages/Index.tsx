          ...
          <div className="container mx-auto container-padding">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                ...
                <div className="content-spacing animate-fade-in order-1 lg:order-2">
                  <div>
                    ...
                    <div className="content-spacing-sm text-sm sm:text-base text-muted-foreground leading-relaxed">
                      <p>
